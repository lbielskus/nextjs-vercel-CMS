    ...
    return (
      <>
          ...
          <div className='mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8 '>
            <div className='flex max-sm:flex-col sm:items-center sm:justify-between items-center'>
              <div className='text-center sm:text-left'>
                <h1 className='text-3xl font-bold text-gray-900 sm:text-3xl mr-10'>
                  All Categories
                </h1>
        ...
        <div className={`overflow-x-auto mx-auto p-4  `}>
          <table className='min-w-full divide-y-2 divide-gray-200 bg-white text-md border rounded mb-44'>
            <thead>
              <tr>
